...
import { cartErrorMessage, useCart, useRemoveCartItem, useUpdateCartItem } from '../lib/cart-api';
      ...
      {cartQuery.isPending ? (
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            {cart.items.map((item) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-xs text-slate-400">Còn {item.product.stock} trong kho</p>
                </div>
          ...
          <aside className="card p-6 lg:sticky lg:top-24">
            ...
            <button className="btn-primary btn-lg mt-5 w-full" onClick={() => navigate('/checkout')}>
